...
static m_ble_cfg_t rik_ble_cfg = {
    ...
    .m_ble_bits_on_rx = EVENT_BIT_BLE_RX,
    .m_ble_bits_on_notify_complete = EVENT_BIT_BLE_NOTIFY_DONE,
    .m_ble_bits_on_indication_complete = EVENT_BIT_BLE_IND_DONE,
    .m_ble_bits_on_indication_timeout = EVENT_BIT_BLE_IND_TIMEOUT,
    .m_ble_bits_on_connect = EVENT_BIT_BLE_CONNECTED,
    .m_ble_bits_on_connection_failed = EVENT_BIT_BLE_CONNECTION_FAILED,
    .m_ble_bits_on_disconnect = EVENT_BIT_BLE_DISCONNECTED,
    .m_ble_bits_on_mtu_update = EVENT_BIT_BLE_MTU_UPDATED,
    .task_priority = 3,
...
esp_err_t rik_start_ble(EventGroupHandle_t rik_events){
    rik_ble_cfg.m_ble_events = rik_events;
    ESP_LOGI(TAG, "Event group for BLE assigned");
...
esp_err_t rik_start_i2c(EventGroupHandle_t i2c_rik_events_0, 
...
{ 
    ...
    m_i2c_init(&rik_i2c_cfg_0, &rik_i2c_cfg_1);
    return ESP_OK;
}
