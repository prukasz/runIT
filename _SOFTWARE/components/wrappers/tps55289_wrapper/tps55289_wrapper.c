...
status_rep_t sys_pwr_set_reg_voltage(bool reg_num, uint32_t voltage_mv){
    ...
    return STA_FROM_ESP(tps55289_set_voltage(handle, voltage_mv), OWNER_TPS55289_WRAPPER_SET_VOLTAGE, reg_num);
}

status_rep_t sys_pwr_set_reg_current_limit(bool reg_num, uint32_t limit_ma){
    tps55289_handle_t handle = (reg_num == 0) ? tps_dev_handle_0 : tps_dev_handle_1;
    return STA_FROM_ESP(tps55289_set_current_limit(handle, true, limit_ma), OWNER_TPS55289_WRAPPER_SET_CURRENT_LIMIT, reg_num);
}

status_rep_t sys_pwr_en_reg(bool reg_num, bool state){
    tps55289_handle_t handle = (reg_num == 0) ? tps_dev_handle_0 : tps_dev_handle_1;
    return STA_FROM_ESP(tps55289_set_output_enable(handle, state), OWNER_TPS55289_WRAPPER_EN, reg_num);
}
...
status_rep_t sys_pwr_reg_register_ocp_callback(bool reg_num, void (*callback)(void*), void* ctx){
    ...
    return STA_FROM_ESP(tps55289_set_fault_masks((reg_num == 0) ? tps_dev_handle_0 : tps_dev_handle_1, false, callback ? true : false, false), OWNER_TPS55289_WRAPPER_REGISTER_OCP_CALLBACK, reg_num);
}
...
status_rep_t sys_pwr_reg_register_ovp_callback(bool reg_num, void (*callback)(void*), void* ctx){
    ...
    return STA_FROM_ESP(tps55289_set_fault_masks((reg_num == 0) ? tps_dev_handle_0 : tps_dev_handle_1, false, false, callback ? true : false), OWNER_TPS55289_WRAPPER_REGISTER_OVP_CALLBACK, reg_num);
}
...
status_rep_t sys_pwr_reg_register_scp_callback(bool reg_num, void (*callback)(void*), void* ctx){
    ...
    return STA_FROM_ESP(tps55289_set_fault_masks((reg_num == 0) ? tps_dev_handle_0 : tps_dev_handle_1, callback ? true : false, false, false), OWNER_TPS55289_WRAPPER_REGISTER_SCP_CALLBACK, reg_num);
}
