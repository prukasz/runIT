...
void* p_vreg_0_new(void){
    tps_dev_handle_0 = tps55289_new(CONFIG_I2C_ADDR_TPS55289_0);
    return tps_dev_handle_0;
}

void* p_vreg_1_new(void){
    tps_dev_handle_1 = tps55289_new(CONFIG_I2C_ADDR_TPS55289_1);
...
status_rep_t p_vreg_start(){ 
    if(tps_dev_handle_0){
        CHECK_ESP_CALL_R(tps55289_set_output_enable(tps_dev_handle_0, false));
        CHECK_ESP_CALL_R(tps55289_set_current_limit(tps_dev_handle_0, 100, true));
    }
    if(tps_dev_handle_1){
        CHECK_ESP_CALL_R(tps55289_set_output_enable(tps_dev_handle_1, false));
        CHECK_ESP_CALL_R(tps55289_set_current_limit(tps_dev_handle_1, 100, true));
    }
    return STA_OK;
}
...
status_rep_t p_vreg_set_voltage(bool reg_num, uint32_t voltage_mv){
    ...
    CHECK_ESP_CALL_R(tps55289_set_voltage(handle, voltage_mv));
    return STA_OK;
}
...
status_rep_t p_vreg_set_current_limit(bool reg_num, uint32_t limit_ma){
    tps55289_handle_t handle = (reg_num == 0) ? tps_dev_handle_0 : tps_dev_handle_1;
    CHECK_HANDLE_R(handle);
    CHECK_ESP_CALL_R(tps55289_set_current_limit(handle, true, limit_ma));
    return STA_OK;
}
...
status_rep_t p_vreg_en(bool reg_num, bool state){
    tps55289_handle_t handle = (reg_num == 0) ? tps_dev_handle_0 : tps_dev_handle_1;
    CHECK_HANDLE_R(handle);
    CHECK_ESP_CALL_R(tps55289_set_output_enable(handle, state));
    return STA_OK;
}
...
status_rep_t p_vreg_register_ocp_callback(bool reg_num, void (*callback)(void*), void* ctx){
    ...
    CHECK_ESP_CALL_R(tps55289_set_fault_masks(handle, false, callback ? true : false, false));
    return STA_OK;
}
...
status_rep_t p_vreg_register_ovp_callback(bool reg_num, void (*callback)(void*), void* ctx){
    ...
    CHECK_ESP_CALL_R(tps55289_set_fault_masks(handle, false, false, callback ? true : false));
    return STA_OK;
}
...
status_rep_t p_vreg_register_scp_callback(bool reg_num, void (*callback)(void*), void* ctx){
    ...
    CHECK_ESP_CALL_R(tps55289_set_fault_masks(handle, callback ? true : false, false, false));
    return STA_OK;
}
