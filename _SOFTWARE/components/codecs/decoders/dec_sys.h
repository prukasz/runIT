...
static inline status_rep_t decoder_packet_sys_device_uninstall_t(packet_sys_device_uninstall_t* packet) { return sys_device_uninstall(packet->device_id); }
...
static inline status_rep_t decoder_packet_sys_device_reset_t(packet_sys_device_reset_t* packet) { return sys_device_reset(packet->device_id); }
...
static inline status_rep_t decoder_packet_sys_device_suspend_t(packet_sys_device_suspend_t* packet) { return sys_device_suspend(packet->device_id); }
...
static inline status_rep_t decoder_packet_sys_device_resume_t(packet_sys_device_resume_t* packet) { return sys_device_resume(packet->device_id); }
...
static inline status_rep_t decoder_packet_sys_device_suspend_all_t(packet_sys_device_suspend_all_t* packet) { return sys_device_suspend_all(); }
...
static inline status_rep_t decoder_packet_sys_device_resume_all_t(packet_sys_device_resume_all_t* packet) { return sys_device_resume_all(); }
...
static inline status_rep_t decoder_packet_sys_device_freeze_t(packet_sys_device_freeze_t* packet) { return sys_device_freeze(packet->device_id); }
...
static inline status_rep_t decoder_packet_sys_device_sync_t(packet_sys_device_sync_t* packet) { return sys_device_sync(packet->device_id); }
...
static inline status_rep_t decoder_packet_sys_device_freeze_all_t(packet_sys_device_freeze_all_t* packet) { return sys_device_freeze_all(); }
...
static inline status_rep_t decoder_packet_sys_device_sync_all_t(packet_sys_device_sync_all_t* packet) { return sys_device_sync_all(); }
...
static inline status_rep_t decoder_packet_sys_io_reset_t(packet_sys_io_reset_t* packet) { return sys_io_reset(packet->device_id, packet->pin); }
...
static inline status_rep_t decoder_packet_sys_io_set_mode_t(packet_sys_io_set_mode_t* packet) { return sys_io_set_mode(packet->device_id, packet->pin, (sys_io_mode_e)packet->mode); }
...
static inline status_rep_t decoder_packet_sys_io_set_level_t(packet_sys_io_set_level_t* packet) { return sys_io_set_level(packet->device_id, packet->pin, packet->level != 0); }
...
static inline status_rep_t decoder_packet_sys_io_get_level_t(packet_sys_io_get_level_t* packet) {
  bool level = false;
  status_rep_t err = sys_io_get_level(packet->device_id, packet->pin, &level);
  if (STA_IS_OK(err)) {
...
static inline status_rep_t decoder_packet_sys_io_toggle_t(packet_sys_io_toggle_t* packet) { return sys_io_toggle(packet->device_id, packet->pin); }
...
static inline status_rep_t decoder_packet_sys_io_get_voltage_t(packet_sys_io_get_voltage_t* packet) {
  uint32_t out_mV = 0;
  status_rep_t err = sys_io_get_voltage(packet->device_id, packet->pin, &out_mV);
  if (STA_IS_OK(err)) {
...
static inline status_rep_t decoder_packet_sys_io_set_voltage_t(packet_sys_io_set_voltage_t* packet) { return sys_io_set_voltage(packet->device_id, packet->pin, packet->voltage_mV); }
...
static inline status_rep_t decoder_packet_sys_io_set_pwm_frequency_t(packet_sys_io_set_pwm_frequency_t* packet) { return sys_io_set_pwm_frequency(packet->device_id, packet->pin, packet->frequency_HZ); }
...
static inline status_rep_t decoder_packet_sys_io_set_pwm_duty_t(packet_sys_io_set_pwm_duty_t* packet) { return sys_io_set_pwm_duty(packet->device_id, packet->pin, packet->duty); }
...
static inline status_rep_t decoder_packet_sys_power_budget_update_source_t(packet_sys_power_budget_update_source_t* packet) { return sys_power_budget_update_source(packet->max_mV, packet->max_mA); }
...
static inline status_rep_t decoder_packet_sys_vreg_set_enable_t(packet_sys_vreg_set_enable_t* packet) { return sys_vreg_set_enable(packet->device_id, packet->state != 0); }
...
static inline status_rep_t decoder_packet_sys_vreg_set_voltage_t(packet_sys_vreg_set_voltage_t* packet) { return sys_vreg_set_voltage(packet->device_id, packet->voltage_mV); }
...
static inline status_rep_t decoder_packet_sys_vreg_set_current_t(packet_sys_vreg_set_current_t* packet) { return sys_vreg_set_current(packet->device_id, packet->current_mA); }
...
static inline status_rep_t decoder_packet_sys_power_monitor_get_voltage_t(packet_sys_power_monitor_get_voltage_t* packet) {
  int32_t out_mV = 0;
  status_rep_t err = sys_power_monitor_get_voltage(packet->device_id, packet->channel, &out_mV);
  if (STA_IS_OK(err)) {
...
static inline status_rep_t decoder_packet_sys_power_monitor_get_current_t(packet_sys_power_monitor_get_current_t* packet) {
  int32_t out_mA = 0;
  status_rep_t err = sys_power_monitor_get_current(packet->device_id, packet->channel, &out_mA);
  if (STA_IS_OK(err)) {
...
static inline status_rep_t decoder_packet_sys_power_usb_pd_set_t(packet_sys_power_usb_pd_set_t* packet) { return sys_power_usb_pd_set(packet->device_id, packet->voltage_mV, packet->current_mA); }
...
static inline status_rep_t decoder_packet_sys_power_usb_pd_list_t(packet_sys_power_usb_pd_list_t* packet) { return sys_power_usb_pd_list(packet->device_id); }
...
static inline status_rep_t decoder_packet_sys_power_usb_pd_get_limits_t(packet_sys_power_usb_pd_get_limits_t* packet) {
  uint32_t out_mV = 0;
  uint32_t out_mA = 0;
  status_rep_t err = sys_power_usb_pd_get_limits(packet->device_id, &out_mV, &out_mA);
  if (STA_IS_OK(err)) {
