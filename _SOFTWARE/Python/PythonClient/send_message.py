...
# Build the Code object so global Mem is populated for alias resolution
import example  # noqa: F401  — side-effect: populates Mem with contexts & aliases
