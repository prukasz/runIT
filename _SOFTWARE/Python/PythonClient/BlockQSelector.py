"""
BlockQSelector - select one of N boolean outputs based on selector value.
Like a switch-case statement: based on selector value, sets one output
Allows chaining multiple blocks 
"""
...
class BlockQSelector(Block):
    ...
    Inputs:
        ...
        - in_1 (SEL): Selector value (as U8) - index of output to activate
    ...
    def __init__(self,
        ...
        super().__init__(idx=idx, block_type=block_types_t.BLOCK_Q_SELECTOR, ctx_id=ctx_id, alias=alias, mem=mem)
