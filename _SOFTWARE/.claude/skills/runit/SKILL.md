...
| `state`, `mode`, `frozen`, `suspend`, `reset`, `hard-reset`, `online`, `offline`, `connection lost`, `emergency` | `components/system/sys_states` | [SYS_STATES.MD](file:///c:/Users/krolp/Documents/runIT_main/_SOFTWARE/components/system/sys_states/SYS_STATES.MD) | [sys_states.h](file:///c:/Users/krolp/Documents/runIT_main/_SOFTWARE/components/system/sys_states/include/sys_states.h) |
| `action`, `record`, `replay`, `invoke`, `macro`, `interceptor`, `tap`, `preconfiguration`, `boot action`, `bind state`, `nvs` | `components/system/sys_actions` | [SYS_ACTIONS.MD](file:///c:/Users/krolp/Documents/runIT_main/_SOFTWARE/components/system/sys_actions/SYS_ACTIONS.MD) | [sys_actions.h](file:///c:/Users/krolp/Documents/runIT_main/_SOFTWARE/components/system/sys_actions/include/sys_actions.h) |
